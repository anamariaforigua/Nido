...
- Guardado en Neon Postgres cuando se despliega en Vercel.
...
3. Agrega una base de datos Neon desde Vercel Marketplace/Storage y conéctala al proyecto.
...
Neon agregará `DATABASE_URL` automáticamente. La tabla `survey_responses` se crea automáticamente cuando llegue la primera respuesta o cuando abras `/resultados`.
